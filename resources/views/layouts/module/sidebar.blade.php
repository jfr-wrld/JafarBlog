  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
        <img src="https://avatars.githubusercontent.com/u/81171045?v=4" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
            style="opacity: .8">
        <span class="brand-text font-weight-light">Jafar.id</span>
    </a>
    <!-- Sidebar -->
    <div class="sidebar">
        ...
        <div class="image">
            <img src="https://avatars.githubusercontent.com/u/81171045?v=4" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
            <a href="#" class="d-block">Asidik Al Jafar</a>
        </div>
        </div>
