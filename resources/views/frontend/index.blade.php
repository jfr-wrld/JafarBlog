                  ...
                  <a href="{{ url('/article/' . $lat->slug) }}" class="a-block d-flex align-items-center height-lg" style="background-image: url('{{ asset('storage/' . $lat->header_articles) }}'); ">
                    <div class="text half-to-full">
                      ...
                      <div class="post-meta">
                        ...
                        <span class="author mr-2"><img src="{{ asset('front/images/person_jafar.png') }}" alt="Colorlib"> {{$lat->created_by}}</span>&bullet;
              ...
              @forelse($articles as $row)  
                <div class="col-md-6">
                  <a href="{{ url('/article/' . $row->slug) }}" class="blog-entry element-animate" data-animate-effect="fadeIn">
                    ...
                    <div class="post-meta">
                      <span class="author mr-2"><img src="{{ asset('front/images/person_jafar.png') }}" alt="Colorlib"> {{$row->created_by}}</span>&bullet;
                      <span class="mr-2">{{$row->category->name}}</span> &bullet;
                      <span class="mr-2"><span class="fa fa-thumbs-up"></span> {{$row->like}}</span> &bullet;
