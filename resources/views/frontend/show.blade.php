		  ...
		  <div class="row blog-entries element-animate">
			...
			<div class="col-md-12 col-lg-8 main-content">
			  <img src="{{ asset('storage/' . $article->header_articles) }}" alt="{{ $article->title }}" class="img-fluid mb-5">
			   <div class="post-meta">
					<span class="author mr-2"><img src="{{ asset('front/images/person_jafar.png')}}" alt="Colorlib" class="mr-2"> {{$article->created_by}}</span>&bullet;
				...
				<ul class="comment-list">
					...
					<li class="comment">
						...
						<ul class="children">
							<li class="comment">
							  <div class="vcard">
								<img src="{{ asset('front/images/person_jafar.png')}}" alt="Image placeholder">
							  </div>
							  <div class="comment-body">
								<h3>{{ $val->username }}</h3>
								<p>{{ $val->comment }}</p>
